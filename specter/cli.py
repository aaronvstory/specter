...
def build_parser():
    ap = argparse.ArgumentParser(prog="ghostprint")
    sub = ap.add_subparsers(dest="cmd", required=True)
    p = sub.add_parser("new"); p.add_argument("--name"); p.add_argument("--no-us-bias", action="store_true"); p.set_defaults(f=cmd_new)
    p = sub.add_parser("push"); p.add_argument("--name"); p.add_argument("--pkg", default="com.doordash.driverapp"); p.add_argument("--no-clear", action="store_true"); p.set_defaults(f=cmd_push)
    p = sub.add_parser("rotate"); p.add_argument("--pkg", default="com.doordash.driverapp"); p.add_argument("--no-clear", action="store_true"); p.add_argument("--no-us-bias", action="store_true"); p.set_defaults(f=cmd_rotate)
