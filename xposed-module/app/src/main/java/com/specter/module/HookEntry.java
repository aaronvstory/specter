...
public class HookEntry implements IXposedHookLoadPackage {
     ...
     *  case) reads Location.isFromMockProvider() / isMock() to detect a spoofed GPS. Specter does NOT spoof
     *  GPS coordinates (left to a dedicated tool like Lockito); forcing these to FALSE ensures a separate
     *  location-mocker isn't given away by a mock-location tell. Gated with the hide_mock protection. */
